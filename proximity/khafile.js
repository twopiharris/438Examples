// Auto-generated
let project = new Project('proximity');
...
project.addParameter('arm.node.Proximity');
project.addParameter("--macro keep('arm.node.Proximity')");
...
project.addShaders("build_proximity/compiled/Shaders/*.glsl", { noembed: false});
project.addAssets("build_proximity/compiled/Assets/**", { notinlist: true });
project.addAssets("build_proximity/compiled/Shaders/*.arm", { notinlist: true });
