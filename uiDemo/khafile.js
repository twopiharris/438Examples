// Auto-generated
let project = new Project('uiDemo');
...
project.addShaders("build_uiDemo/compiled/Shaders/*.glsl", { noembed: false});
project.addAssets("build_uiDemo/compiled/Assets/**", { notinlist: true });
project.addAssets("build_uiDemo/compiled/Shaders/*.arm", { notinlist: true });
project.addAssets("../approaching_storm.jpg", { notinlist: true });
